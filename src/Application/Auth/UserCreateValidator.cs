...
namespace Application.Auth
{
    ...
    public class PasswordValidator : AbstractValidator<IPasswordValidator>
    {
    ...
    public class ChildCreateValidator : AbstractValidator<IChildValidator>
    {
        public ChildCreateValidator()
        {
            RuleFor(x => x.FirstName)
                .NotEmpty().WithMessage("First Name is required.")
                .MaximumLength(50).WithMessage("First Name must not exceed 50 characters.");
